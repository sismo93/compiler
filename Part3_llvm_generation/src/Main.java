...
public class Main{
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException{
        ...
        FileReader source = new FileReader(commandLine.getTestFile()); // read given file
        ...
        */
		...
		try{
			Parser parser = new Parser(iterator,commandLine);
			ParseTree parserTree = parser.startParser();
			Generate generate = new Generate();			
			List<String> instruction = generate.generateInstruct(parserTree);
			generate.writeMain();
			generate.handleArgsDemande(commandLine);
